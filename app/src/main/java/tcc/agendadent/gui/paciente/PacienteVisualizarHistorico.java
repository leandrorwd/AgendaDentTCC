...
public class PacienteVisualizarHistorico extends AppCompatActivity {
    ...
    private AppCompatButton botaoAvaliarConsulta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.paciente_visualiza_historico);
        instanciaArtefatos();
        setEventos();
        Intent i = getIntent();
...
//            }
    ...
    private void setEventos() {
        botaoAvaliarConsulta.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void instanciaArtefatos() {
        ...
        botaoAvaliarConsulta = (AppCompatButton) findViewById(R.id.botaoAvaliarConsulta);
